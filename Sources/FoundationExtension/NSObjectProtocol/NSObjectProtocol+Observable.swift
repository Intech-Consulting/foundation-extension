...
extension NSObjectProtocol where Self: NSObject {
    public func observe<Value>(_ keyPath: KeyPath<Self, Value>,
    ...
    public func observe<Value, Target>(to bindable: Target,
    ...
    public func observe<Value, Target: AnyObject>(to bindable: Target,
                                                  keyPath: KeyPath<Self, Value>,
                                                  onChange: @escaping (Target, Value) -> Void) -> Disposable {
